...
export default () => {
    ...
    const urlApiLocal = '/v1/events/list/allpages';
    ...
    it("List all events: Bad request 1", ( done ) => {
    ...
    it("List all events: Bad request 2", ( done ) => {
        let headers = {
    ...
    it("List all events: success", ( done ) => {
        let now = new Date();
        let now1 = new Date();
    ...
    it("List all events: nextSyncToken", ( done ) => {
        let now = new Date();
        let now1 = new Date();
